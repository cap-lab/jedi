...
void YoloOnnxApplication::postprocessing1(int thread_id, int sample_index, IN void **output_buffers, int output_num, int batch)
{
...
void YoloOnnxApplication::writeResultFile(std::string result_file_name) {
