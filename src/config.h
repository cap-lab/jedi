...
class ConfigData {
	...
	private:
		...
		void readSaveLayerInfo(libconfig::Setting &setting, ConfigInstance &config_instance);
		void readCudaGraphs(libconfig::Setting &setting, ConfigInstance &config_instance);
};
