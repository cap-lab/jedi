...
class OnnxModel : public Model {
	public:
		...
		void separateOnnxFile(nvinfer1::INetworkDefinition *network, std::string model_name, std::string quantized_model_name, std::string secondary_model_name, std::vector<std::string> &plan_file_name_vec);
	...
	private:
		...
		void getModelFileName(int curr, std::string &plan_file_name, nvinfer1::INetworkDefinition *network, std::string postfix, bool for_rt_build, bool quantized_model_avaiable, bool use_secondary);
